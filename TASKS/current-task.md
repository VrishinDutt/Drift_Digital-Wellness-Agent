...
## Open Questions
- TBD
Task: Establish Drift Apple-native verification baseline

Goal:
Validate the current Drift Xcode project structure and identify the reproducible build command.

Allowed:
- TESTING.md
- XCODE_WORKFLOW.md
- TASKS/current-task.md
- documentation-only governance files
...
- ai xcode
- xschemes
- xbuild <actual scheme name>

Risk:
Medium, because this project is Apple-native and privacy-sensitive.
